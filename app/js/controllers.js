...
angular.module('myApp.controllers', []).
    controller('MyCtrl1', ['$scope','$http','$modal', '$log',
    function($scope, $http, $modal, $log) {
        ...
        $scope.open = function () {
            ...
            modalInstance.result.then(function (selectedItem) {
                $scope.selectedTestItem = selectedItem;
            }, function () {
            ...
            $scope.tabs = [
                {
                    ...
                    content:"<li><a href=\"javascript:void(0);\" class=\"continents_select\" onclick=\"continent_select(10,'亚洲')\" value=\"10\" name=\"亚洲\">亚洲</a></li>"
                },
                {
    ...
    var ModalInstanceCtrl = function($scope, $modalInstance, items) {
        ...
        $scope.items = items;
        $scope.selectedTestItem = {
            item: $scope.items[0]
        };

        $scope.ok = function () {
            $modalInstance.close($scope.selectedTestItem.item);
        };
